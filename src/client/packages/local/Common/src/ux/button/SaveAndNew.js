Ext.define('Common.ux.button.SaveAndNew', {
    ...
    getMenus: function () {
        var me = this,
            saveMenuStateId = me.saveAndNewMenuStateId,
            saveAndNewMenuStateId = me.saveAndNewMenuStateId,
            form = me.up('form'),
            id = Ext.id();
        if (Ext.isEmpty(me.saveMenuStateId)){
            saveMenuStateId = form ? form.xtype + 'savemenu' : 'savemenu-'+ id;
        } 
        if (Ext.isEmpty(me.saveAndNewMenuStateId)) {
            saveMenuStateId = form ? form.xtype + 'saveandnewmenu' : 'saveandnewmenu-'+ id;
        }
        return [
            {
                xtype: 'menucheckitem',
